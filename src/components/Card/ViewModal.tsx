...
const ViewModal = ({ info }: { info: PokemonTCG.Set }) => {
  ...
  return (
    <>
      ...
      <button
        onClick={handleModal}
        className="mt-5 btn text-gray-900 font-bold bg-gradient-to-r from-teal-400 to-lime-200 hover:bg-gradient-to-l hover:from-teal-200 hover:to-lime-200 focus:ring-4 focus:outline-none focus:ring-lime-200 dark:focus:ring-teal-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center my-4 block mx-auto"
      >
        Quick view
      </button>
